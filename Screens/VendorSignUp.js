...
import { faAddressBook, faBowlFood, faEnvelope, faLock, faUnlock } from '@fortawesome/free-solid-svg-icons';



export default VendorSignUp = ({navigation}) => {
    ...
    return (
        <SafeAreaView> 
            ...
            <View style={{ alignItems: 'center', marginTop: 100,  }}>
                ...
                <Text style={{ fontSize: 20, padding:10 }}>Vendor</Text>
            </View>
